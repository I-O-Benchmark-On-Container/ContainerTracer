...
$(document).ready(function () {
    ...
    const $appDriverDisplay = $('#appDriverDisplay');
    ...
    $btnSelectWork.on('click', function () {
        ...
        $appDriverDisplay.addClass('hide');

        switch (driver) {
            case "app-driver":
                activateAppDriverListener(socket); // app-driver.js
                $appDriverDisplay.removeClass('hide');
                appDriverChartDisplay(); // app-driver-chart.js
                break;
            default:
